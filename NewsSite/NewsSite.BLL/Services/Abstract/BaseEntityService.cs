...
namespace NewsSite.BLL.Services.Abstract
{
        ...
        where TResult : BaseResponse
    {
        ...
        public abstract Expression<Func<TEntry, bool>> GetFilteringExpressionFunc(string propertyName, string propertyValue);

        public abstract Expression<Func<TEntry, object>> GetSortingExpressionFunc(string sortingValue);

        public virtual async Task<PageList<TResult>> GetAllAsync(IQueryable<TEntry> items, PageSettings? pageSettings)
        {
