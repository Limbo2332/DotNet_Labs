    ...
    public class CustomFullNameRuleBuilderTests
    {
        ...
        public async Task CustomFullName_Should_Fail_WhenFullNameIsEmpty()
        {
            ...
            using (new AssertionScope())
            {
                ...
                result.Errors.Should().Contain(x => 
                    x.ErrorMessage == ValidationMessages.GetEntityIsEmptyMessage(ValidationMessages.FULL_NAME_PROPERTY_NAME));
            }
        }
        ...
        public async Task CustomFullName_Should_Fail_WhenFullNameNotInCorrectFormat(string fullName)
        {
            ...
            using (new AssertionScope())
            {
                result.IsValid.Should().BeFalse();
                result.Errors.Should().Contain(
                    x => x.ErrorMessage == ValidationMessages.GetEntityWithWrongFormatMessage(ValidationMessages.FULL_NAME_PROPERTY_NAME));
            }
        }
